...
# --- Set up page and custom CSS (from mainB.py) ---
st.set_page_config(
...
# --- Session State Initialization (superset of both files) ---
...
# --- Predefined Question Cards (from mainB.py, with correct logic) ---
...
# --- Conversation Chat Bubbles (UI from mainB.py) ---
...
for idx, msg in enumerate(st.session_state["chat_history"]):
    if msg["role"] == "assistant":
        ...
        # Show sources bubble for the bot message, if available
...
# --- Submit Query Helper, maintains all correct chat state ---
def submit_query():
...
# --- Input Field at Bottom (UI from mainB.py, input logic from main2.py) ---
...
# --- Message Sending Logic, using real answer_query ---
if st.session_state["pending_query"]:
    ...
    with st.spinner("Retrieving answer..."):
        try:
            ...
            st.session_state["latency"] = result.get("latency", None)
            st.rerun()
